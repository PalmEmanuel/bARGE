...
│   ├── azureService.ts                  # Azure authentication & querying
│   ├── bargePanel.ts                    # Results panel management
│   ├── resultsViewProvider.ts           # Webview provider
...
├── package.json                         # npm scripts & VS Code manifest
├── tsconfig.json                        # TypeScript configuration
├── eslint.config.mjs                    # ESLint configuration  
├── esbuild.js                           # Build script
├── language-configuration.json          # KQL language support
